...
use Seat\Console\Models\Sde\InvUniqueName;
use Symfony\Component\Yaml\Yaml;

class UniqueNameReader extends AbstractReader
{
    public function parse()
    {
        ...
        foreach ($content as $uniqueName) {
            if ($this->checkItemStructure($uniqueName)) {

                InvUniqueName::updateOrCreate([
                    'itemID' => $uniqueName['itemID'],
                ], [
                    'itemName' => $uniqueName['itemName'],
                    'groupID' => $uniqueName['groupID']
                ]);
    ...
    {
        $fields = ['itemID', 'itemName', 'groupID'];
