...
use Seat\Console\Models\Sde\InvMetaType;
use Symfony\Component\Yaml\Yaml;

class MetaTypeReader extends AbstractReader
{
    public function parse()
    {
        ...
        foreach ($content as $metaType) {
            if ($this->checkItemStructure($metaType)) {

                InvMetaType::updateOrCreate([
                    'typeID' => $metaType['typeID'],
                ], [
                    'parentTypeID' => $metaType['parentTypeID'],
    ...
    {
        $fields = ['typeID', 'parentTypeID', 'metaGroupID'];
